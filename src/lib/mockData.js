export const mockCars = [
  {
    ...
    description: "This pristine 2021 Maruti Suzuki XL6 Alpha is a top-of-the-line variant, certified by Maruti Suzuki True Value. Features captain seats in the second row, leather interiors, and Smart Hybrid Petrol efficiency.",
    image_url: "https://lh3.googleusercontent.com/aida-public/AB6AXuDITYFHj1B-X4XYY9Jplq9tZDx2L8kvaMDXKzb6zmL_RBDt2yNdLi6AKeDg7rnBaSzD-FmHFWTLxDWFwcnlCmCtHCEFcTxnL6fcvVzD6jh_RlSknq_WNSSjrR6bTi1m0uiPR0OwJFQl6LQv3jbdxXAFNib7Svtfmbt7lLXB8zX7YwljYfAwybjnYo7shgy17fpo5MNx0DlFXE8os5fhldeWNxhKpaFBzFIJ3qL45LxsF8IHp7j84VOJIPWmiNPcX9NI5OpUp4IbVzWd",
    gallery: [
  ...
  },
  {
    ...
    description: "Vibrant Maruti Suzuki Swift ZXi+ with advanced automated manual transmission (AMT). Excellent mileage, sporty red exteriors, and a certified history.",
  ...
  },
  {
    ...
    description: "Classy silver sedan with maximum rear legroom and luxury comfort. Economical diesel engine with Smart Hybrid assistance for great range.",
  ...
  },
  {
    ...
    description: "Next-generation hybrid SUV with e-CVT and silent electric drive option. Loaded with sunroof, 360-degree camera, and advanced safety features.",
    image_url: "https://lh3.googleusercontent.com/aida-public/AB6AXuB_13V0IHbsVbBh9W9xqdRHVpGYo_hfku6Ysdrq_JHCINzumVzaDty6DvArh9zpvtPbwrZBX6FSJcMpXpUXfKlNI9DCbtHfcBaNx9fe08AqPxg4bfQfWhC5pQvY8Rob87bEoPnzy_CxVfiLl_CRAlHODmOCAgu7vC6nTp057KThcHnbnRnr4PoHW0WUGzoADSUi_Xo9-ysfC-HCD_C6Cbel5v6tEulIU3eBZaaA6lHeuqTWZkfrzj3eJSsxTqFOXSIqvUS24HWdkun6",
    gallery: [
